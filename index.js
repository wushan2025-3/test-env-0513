...
export default {
  async fetch(request, context, env) {
    ...
    const subUrl = url.searchParams.get("subUrl") || "https://other.anycast3.xxxtest.alicdn-test.com/v2/files/hello_er.txt";
    const overrideHost = url.searchParams.get("host") || "other.anycast3.xxxtest.alicdn-test.com";
