...
export default {
  async fetch(request, context, env) {
    ...
    const subUrl = url.searchParams.get("subUrl") || "https://testcdn.1.alicdn-test.com/v2/files/hello_er.txt";
    const overrideHost = url.searchParams.get("host") || "testcdn.4.alicdn-test.com";
